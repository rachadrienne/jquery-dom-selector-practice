...
(function () {
 ...
 //   $("#button1").click(question1);
     ...
     */
     ...
     // function question2 () {
    // $("h2").replaceWith("<h2>Rachel Malone</h2>");
    // }
...
//    $('#button2').click(blockquote);
   ...
   // function headerH1() {
   //     $('header h1').replaceWith('<h1>jQuary Ninja</h1>');
 //   }
    
  //  $('#button2').click(headerH1);
    ...
    // img tag with class city had its src changed to a url with new picture to be displayed on click of button 3.
